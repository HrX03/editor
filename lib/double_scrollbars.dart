  ...
  Widget build(BuildContext context) {
    return NotificationListener<ScrollNotification>(
      onNotification: (notification) {
        final _ScrollReceiverState provider = switch (direction) {
          Axis.vertical => VerticalScrollReceiver.of(context),
          Axis.horizontal => HorizontalScrollReceiver.of(context),
        };
